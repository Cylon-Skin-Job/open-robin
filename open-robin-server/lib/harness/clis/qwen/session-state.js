...
/**
 * Session state for a single Qwen ACP thread.
 * Mirrors GeminiSessionState since Qwen uses the same ACP protocol.
 * Tracks conversation state, tool calls, and content accumulation.
 */
class QwenAcpSessionState {
  constructor() {
...
module.exports = { QwenAcpSessionState };
